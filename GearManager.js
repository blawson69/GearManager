...
var GearManager = GearManager || (function () {
    ...
    var version = '0.2',
        ...
        gear = [
            ...
            {name: "Ball Bearings", shaped_script: true, section: "utility", category: "Adventuring Gear", content: "As an action, you can spill these tiny metal balls from their pouch to cover a level, square area that is 10 feet on a side. A creature moving across the covered area must succeed on a DC 10 Dexterity saving throw or fall prone. A creature moving through the area at half speed doesn’t need to make the save.", saving_throw_vs_ability: "DEXTERITY", saving_throw_dc: 10, weight: 2},
            {name: "Poison", shaped_script: false, section: "utility", category: "Adventuring Gear", content: "You can use the poison in this vial to coat one slashing or piercing weapon or up to three pieces of Ammunition. Applying the poison takes an action. A creature hit by the Poisoned weapon or Ammunition must make a DC 10 Constitution saving throw or take 1d4 poison damage. Once applied, the poison retains potency for 1 minute before drying.", weight: 0},
            {name: "Caltrops", shaped_script: true, section: "utility", category: "Adventuring Gear", content: "As an action, you can spread a single bag of caltrops to cover a 5-foot-square area. Any creature that enters the area must succeed on a DC 15 Dexterity saving throw or stop moving and take 1 piercing damage. Until the creature regains at least 1 hit point, its walking speed is reduced by 10 feet. A creature moving through the area at half speed doesn't need to make the saving throw.", saving_throw_vs_ability: "DEXTERITY", saving_throw_dc: 15, weight: 2},
